...
ROOT_DIR = environ.Path(__file__) - 3  # (friendcheck/config/settings/base.py - 3 = friendcheck/)
APPS_DIR = ROOT_DIR.path('friendcheck')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///friendcheck'),
}
...
MIGRATION_MODULES = {
    'sites': 'friendcheck.contrib.sites.migrations'
}
...
LOGIN_REDIRECT_URL = 'facebook:overview' #'users:redirect'
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'friendcheck.users.adapters.SocialAccountAdapter'
